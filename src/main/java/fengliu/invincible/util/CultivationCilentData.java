...
public class CultivationCilentData {
    ...
    protected static CultivationLevel[] CultivationLevelAll = {
        ...
        // 练气
        new CultivationLevel(1, "invincible.cultivation_level.1", 10000, 20000, 99, 0, 0, 100),
        new CultivationLevel(2, "invincible.cultivation_level.2", 20000, 31000, 99, 0, 0, 110),
        new CultivationLevel(3, "invincible.cultivation_level.3", 31000, 43000, 99, 0, 0, 120),
        new CultivationLevel(4, "invincible.cultivation_level.4", 43000, 56000, 98, 0, 0, 130),
        new CultivationLevel(5, "invincible.cultivation_level.5", 56000, 70000, 97, 0, 0, 140),
        new CultivationLevel(6, "invincible.cultivation_level.6", 70000, 85000, 96, 0, 0, 150),
        new CultivationLevel(7, "invincible.cultivation_level.7", 85000, 100000, 94, 0, 0, 160),
        new CultivationLevel(8, "invincible.cultivation_level.8", 100000, 116000, 93, 0, 0, 170),
        new CultivationLevel(9, "invincible.cultivation_level.9", 116000, 133000, 92, 0, 0, 180),
        new CultivationLevel(10, "invincible.cultivation_level.10", 133000, 180000, 90, 0, 0, 190),
        // 筑基
        new CultivationLevel(11, "invincible.cultivation_level.11", 180000, 200000, 89, 0, 0, 250),
        new CultivationLevel(12, "invincible.cultivation_level.12", 200000, 221000, 88, 0, 0, 260),
        new CultivationLevel(13, "invincible.cultivation_level.13", 221000, 242000, 87, 0, 0, 270),
        new CultivationLevel(14, "invincible.cultivation_level.14", 242000, 264000, 85, 0, 0, 280),
        new CultivationLevel(15, "invincible.cultivation_level.15", 264000, 288000, 84, 0, 0, 290),
        new CultivationLevel(16, "invincible.cultivation_level.16", 288000, 313000, 83, 0, 0, 300),
        new CultivationLevel(17, "invincible.cultivation_level.17", 313000, 339000, 82, 0, 0, 310),
        new CultivationLevel(18, "invincible.cultivation_level.18", 339000, 366000, 80, 0, 0, 320),
        new CultivationLevel(19, "invincible.cultivation_level.19", 366000, 396000, 79, 0, 0, 330),
        new CultivationLevel(20, "invincible.cultivation_level.20", 396000, 425000, 78, 0, 0, 340),
        new CultivationLevel(21, "invincible.cultivation_level.21", 425000, 451000, 75, 0, 0, 350),
        new CultivationLevel(22, "invincible.cultivation_level.22", 451000, 483000, 73, 0, 0, 360),
        new CultivationLevel(23, "invincible.cultivation_level.23", 483000, 500000, 70, 0, 0, 370),
    };
