...
public class NotZhenFu_Screen extends HandledScreen<NotZhenFu_ScreenHandler>{
    private static final Identifier TEXTTURE = new Identifier(invincibleMod.MOD_ID, "textures/gui/not_zhen_fu.png");

    public NotZhenFu_Screen(NotZhenFu_ScreenHandler handler, PlayerInventory inventory, Text title) {
